...
#            'customer': {'input': 'customer', 'label': _('Search in Customer')},
        ...
        return request.render("helpdesk_technical_support.portal_my_tickets", values)
    ...
    def my_tickets_ticket(self, ticket_id=None, **kw):
        ...
        return request.render("helpdesk_technical_support.my_tickets_ticket", {'ticket': ticket})
    ...
    def new_ticket(self, **kw):
        ...
        return request.render("helpdesk_technical_support.new_ticket", vals)
    ...
    def ticket_thanks(self, **kw):
        ...
        return request.render("helpdesk_technical_support.ticket_thanks", vals)
    ...
    def helpdesk(self, **kw):
        ...
        # return request.render("helpdesk_technical_support.helpdesk",{ 'teams' : teams,
        #                                             'team': team,
