...
class MrpStockReport(models.TransientModel):
    ...
    def _get_reference(self, move_line):
        ...
        if move_line.move_id.part_id:
            res_model = 'part.order'
            res_id = move_line.move_id.part_id.id
            ref = move_line.move_id.part_id.name
    ...
    def _get_linked_move_lines(self, move_line):
        ...
        if not move_lines:
            move_lines = move_line.move_id.part_id and move_line.consume_line_ids
        if not is_used:
            is_used = move_line.move_id.part_id and move_line.produce_line_ids
