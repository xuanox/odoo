...
class continuing_education_tags(models.Model):
   ...
   equipment_ids = fields.Many2many('continuing.education.ticketin', id1='category_id', id2='equipment_id', string='Equipments')


class ContinuingEducationTicketin(models.Model):
    _name = 'continuing.education.ticketin'
    _description = 'Continuing Education Ticket In'
    _order = 'name'
