...
class RegulatoryTechnicalFileRegistryAssign(models.TransientModel):
    _name = 'regulatory.technical.file.registry.assign'
    ...
    def assign_request(self):
        ...
        if active_id:
            ...
            request.write({'responsible_id': self.user_id.id})
